...
if "%1"=="" ("D:\programs\matlab 2025b\matlab\bin\win64\gmake" MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  -f ReferenceGeneratorxLQRCombinedxPWMGenerator.mk all) else ("D:\programs\matlab 2025b\matlab\bin\win64\gmake" MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  -f ReferenceGeneratorxLQRCombinedxPWMGenerator.mk %1)
