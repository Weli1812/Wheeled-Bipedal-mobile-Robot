###########################################################################
## Makefile generated for component 'LQRxSTM'. 
## 
## Makefile     : LQRxSTM.mk
## Generated on : Thu May 07 18:37:57 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/LQRxSTM.elf
...
PRODUCT_NAME              = LQRxSTM
MAKEFILE                  = LQRxSTM.mk
MATLAB_ROOT               = D:/programs/matlab 2025b/matlab
MATLAB_BIN                = D:/programs/matlab 2025b/matlab/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/hassa/OneDrive/Desktop/GIU/git/Wheeled-Bipedal-mobile-Robot/Hardware_Testing/LQRxSTM
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = LQRxSTM_comp.rsp
CMD_FILE                  = LQRxSTM.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
EMPTY                     = 
SPACE                     = $(EMPTY) $(EMPTY)
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/LQRxSTM.elf
...
DEFINES_STANDARD = -DMODEL=LQRxSTM -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
CPP_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m7 -mthumb -mlittle-endian -mfloat-abi=hard -mfpu=fpv5-d16 --entry Reset_Handler --specs=nosys.specs  -T "C:\Users\hassa\OneDrive\Desktop\GIU\git\Wheeled-Bipedal-mobile-Robot\Hardware_Testing\LQRxSTM\STM32CubeIDE\STM32H750VBTX_FLASH.ld" --specs=nano.specs
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m7 -mthumb -mlittle-endian -mfloat-abi=hard -mfpu=fpv5-d16 --entry Reset_Handler --specs=nosys.specs  -T "C:\Users\hassa\OneDrive\Desktop\GIU\git\Wheeled-Bipedal-mobile-Robot\Hardware_Testing\LQRxSTM\STM32CubeIDE\STM32H750VBTX_FLASH.ld" --specs=nano.specs
...
LDFLAGS_SKIPFORSIL = -mcpu=cortex-m7 -mthumb -mlittle-endian -mfloat-abi=hard -mfpu=fpv5-d16 --entry Reset_Handler --specs=nosys.specs  -T "C:\Users\hassa\OneDrive\Desktop\GIU\git\Wheeled-Bipedal-mobile-Robot\Hardware_Testing\LQRxSTM\STM32CubeIDE\STM32H750VBTX_FLASH.ld" --specs=nano.specs
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -mcpu=cortex-m7 -mthumb -mlittle-endian -mfloat-abi=hard -mfpu=fpv5-d16 --entry Reset_Handler --specs=nosys.specs  -T "C:\Users\hassa\OneDrive\Desktop\GIU\git\Wheeled-Bipedal-mobile-Robot\Hardware_Testing\LQRxSTM\STM32CubeIDE\STM32H750VBTX_FLASH.ld" --specs=nano.specs
...
%.c.o : $(START_DIR)/LQRxSTM_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.s.o : $(START_DIR)/LQRxSTM_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.cpp.o : $(START_DIR)/LQRxSTM_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/LQRxSTM_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/LQRxSTM_ert_rtw/%.C
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.cpp.o : $(START_DIR)/LQRxSTM_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
LQRxSTM.c.o : $(START_DIR)/LQRxSTM_ert_rtw/LQRxSTM.c
	$(CC) $(CFLAGS) -o "$@" "$<"


LQRxSTM_data.c.o : $(START_DIR)/LQRxSTM_ert_rtw/LQRxSTM_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.c.o : $(START_DIR)/LQRxSTM_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
stm32h7xx_it.c.o : $(START_DIR)/Core/Src/stm32h7xx_it.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_msp.c.o : $(START_DIR)/Core/Src/stm32h7xx_hal_msp.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_timebase_tim.c.o : $(START_DIR)/Core/Src/stm32h7xx_hal_timebase_tim.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
stm32h7xx_hal_rcc.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_rcc_ex.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_rcc_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_flash.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_flash_ex.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_flash_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_gpio.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_gpio.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_hsem.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_hsem.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_dma.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dma.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_dma_ex.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_dma_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_mdma.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_mdma.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_pwr.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_pwr.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_pwr_ex.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_pwr_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
stm32h7xx_hal_i2c.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_i2c_ex.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_i2c_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_exti.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_exti.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_tim.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_tim.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_tim_ex.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_tim_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_uart.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_uart.c
	$(CC) $(CFLAGS) -o "$@" "$<"


stm32h7xx_hal_uart_ex.c.o : $(START_DIR)/Drivers/STM32H7xx_HAL_Driver/Src/stm32h7xx_hal_uart_ex.c
	$(CC) $(CFLAGS) -o "$@" "$<"


system_stm32h7xx.c.o : $(START_DIR)/Core/Src/system_stm32h7xx.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
startup_stm32h750vbtx.s.o : $(START_DIR)/STM32CubeIDE/Application/User/Startup/startup_stm32h750vbtx.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
