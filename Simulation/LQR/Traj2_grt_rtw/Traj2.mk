###########################################################################
## Makefile generated for component 'Traj2'. 
## 
## Makefile     : Traj2.mk
## Generated on : Sun Apr 19 12:23:08 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Traj2.exe
...
START_DIR                 = D:\GIU\Sixth semester\Automation Project\Wheeled-Bipedal-mobile-Robot\Simulation\LQR
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = Traj2_comp.rsp
CMD_FILE                  = Traj2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Traj2.exe
...
DEFINES_STANDARD = -DMODEL=Traj2 -DNUMST=2 -DNCSTATES=9 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c "$(START_DIR)\Traj2_grt_rtw\Traj2.c" "$(START_DIR)\Traj2_grt_rtw\Traj2_data.c" "$(START_DIR)\Traj2_grt_rtw\rtGetInf.c" "$(START_DIR)\Traj2_grt_rtw\rtGetNaN.c" "$(START_DIR)\Traj2_grt_rtw\rt_nonfinite.c"
...
OBJS = rt_logging.obj Traj2.obj Traj2_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(RELATIVE_PATH_TO_ANCHOR)\Traj2_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(RELATIVE_PATH_TO_ANCHOR)\Traj2_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(RELATIVE_PATH_TO_ANCHOR)\Traj2_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(RELATIVE_PATH_TO_ANCHOR)\Traj2_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Traj2.obj : "$(START_DIR)\Traj2_grt_rtw\Traj2.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Traj2_grt_rtw\Traj2.c"


Traj2_data.obj : "$(START_DIR)\Traj2_grt_rtw\Traj2_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Traj2_grt_rtw\Traj2_data.c"


rtGetInf.obj : "$(START_DIR)\Traj2_grt_rtw\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Traj2_grt_rtw\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\Traj2_grt_rtw\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Traj2_grt_rtw\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\Traj2_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\Traj2_grt_rtw\rt_nonfinite.c"
