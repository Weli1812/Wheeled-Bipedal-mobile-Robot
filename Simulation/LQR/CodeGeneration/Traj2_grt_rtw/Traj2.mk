...
## 
## Makefile     : Traj2.mk
## Generated on : Mon Apr 20 22:37:36 2026
...
DEFINES_STANDARD = -DMODEL=Traj2 -DNUMST=4 -DNCSTATES=7 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = "$(MATLAB_ROOT)/rtw/c/src/rt_logging.c" $(START_DIR)/Traj2_grt_rtw/Traj2.c $(START_DIR)/Traj2_grt_rtw/Traj2_data.c $(START_DIR)/Traj2_grt_rtw/rtGetNaN.c $(START_DIR)/Traj2_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj Traj2.obj Traj2_data.obj rtGetNaN.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/Traj2_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Traj2_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Traj2_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Traj2_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Traj2_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
rt_logging.obj : $(call ESCAPE_SPACES,$(MATLAB_ROOT))/rtw/c/src/rt_logging.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
rt_main.obj : $(call ESCAPE_SPACES,$(MATLAB_ROOT))/rtw/c/src/common/rt_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
